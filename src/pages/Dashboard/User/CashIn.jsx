...
const CashIn = () => {
    ...
    const handleCashIn=(e)=>{
        ...
        axiosSecure.post("/cashIn",data)
        .then(res=>{
            if(res.data.insertedId){
                e.target.reset()
                toast.success("Request For Cash In")
    ...
    return (
        ...
        <div>
            <Toaster></Toaster>
            <h1 className="text-3xl font-semibold text-center">Cash In</h1>
            ...
            <div className="space-y-5 p-10 mt-10 shadow-2xl shadow-emerald-700">
                ...
                <form onSubmit={handleCashIn} className="space-y-3">
                ...
                <br />
                <button type="submit" className="btn btn-accent w-full text-white">Cash In</button>
                </form>
